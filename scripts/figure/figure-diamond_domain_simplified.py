...
plt.savefig('figure-diamond-domain-simplified.pdf', dpi=300, bbox_inches='tight')
plt.savefig('figure-diamond-domain-simplified.png', dpi=300, bbox_inches='tight')

plt.close()
print("figure-diamond-domain-simplified saved successfully")
