...
solvers = [mathopt.SolverType.HIGHS]  # Really do not need a solver for this
methods = [
...
for solver in solvers:
    for method in methods:
        for target_error in approx_errors:
            # if method == Methods.QUADRATIC and solver not in [mathopt.SolverType.GSCIP, mathopt.SolverType.Gurobi]:
...
df.write_parquet("variables_log_evaluation.parquet")
print(df)
# %%
